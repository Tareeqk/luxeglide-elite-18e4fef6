...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    "hero.desc": "لوكسي جلايد إيليت هي خدمة السائق الخاص الفاخرة الرائدة في دبي، نعيد تعريف السفر بالأناقة والراحة والموثوقية.",
    "hero.call": "اتصل الآن",
    ...
    "about.p1": "لوكسي جلايد إيليت هي خدمة السائق الخاص الفاخرة الرائدة في دبي، نعيد تعريف السفر بالأناقة والراحة والموثوقية. سواء للعمل أو الترفيه، نضمن تنقلاً سلساً وأنيقاً وخالياً من التوتر، لنقدم تجربة نخبوية في كل ميل.",
    ...
    "services.desc": "من خدمات النقل من وإلى المطار إلى خدمة كبار الشخصيات، نقدم مجموعة شاملة من خدمات السائق الخاص الفاخرة المصممة لتلبية احتياجاتك.",
    ...
    "footer.rights": "لوكسي جلايد إيليت لخدمات السائق الخاص. جميع الحقوق محفوظة.",
  },
};
