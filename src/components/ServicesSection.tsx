...
const ServicesSection = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: t("services.hourly.desc"),
    },
    {
      icon: MapPin,
      title: t("services.city.title"),
      description: t("services.city.desc"),
    },
    {
      icon: Shield,
  ...
  return (
    <section id="services" className="py-20 md:py-32 dark">
      <div className="container" ref={ref}>
        ...
        >
          <p className="text-gold font-semibold uppercase text-sm mb-3">
            {t("services.tag")}
          </p>
