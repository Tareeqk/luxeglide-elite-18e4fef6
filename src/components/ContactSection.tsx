  ...
  const items = [
    {
      ...
      detail: "+971 56 242 7288",
      href: `tel:${PHONE}`,
    },
    {
      icon: MessageCircle,
      title: t("contact.wa"),
      detail: t("contact.chat"),
      href: `https://wa.me/${WHATSAPP}`,
    },
    {
      icon: Mail,
      title: t("contact.email"),
      detail: "info@luxeglideelite.ae",
      href: "mailto:info@luxeglideelite.ae",
    },
    {
      icon: MapPin,
      title: t("contact.location"),
      detail: t("contact.dubai"),
      href: "https://maps.app.goo.gl/oMedxFejHPvregjdA?g_st=ic",
    },
  ]
  return (
