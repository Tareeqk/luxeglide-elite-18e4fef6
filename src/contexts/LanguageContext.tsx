...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "services.airport.desc":
      "Seamless airport pickup and drop-off with flight tracking and meet & greet service.",
    "services.hourly.title": "Hourly Chauffeur",
    "services.hourly.desc":
      "Flexible hourly booking for business meetings, city tours, or special occasions.",
    "services.city.title": "City Tours",
    "services.city.desc":
      "Explore Dubai in ultimate comfort with our curated luxury city tour experiences.",
    "services.corporate.title": "Corporate Travel",
    "services.corporate.desc":
      "Professional chauffeur services for executives and corporate events.",
    "services.vip.title": "VIP Services",
    "services.vip.desc":
      "Exclusive VIP transportation for special events, weddings, and high-profile occasions.",
    "services.group.title": "Group Transport",
    "services.group.desc":
      "Premium fleet options for group travel with comfort and style.",

    // Contact
    "contact.tag": "Contact Us",
    "contact.title": "Get in Touch",
    "contact.desc":
      "Ready to experience luxury travel? Reach out to us and we'll arrange the perfect journey for you.",
  ...
  ar: {
    ...
    "about.p1":
      "لوكسي جلايد إيليت هي خدمة السائق الخاص الفاخرة الرائدة في دبي، نعيد تعريف السفر بالأناقة والراحة والموثوقية. سواء للعمل أو الترفيه، نضمن تنقلاً سلساً وأنيقاً وخالياً من التوتر، لنقدم تجربة نخبوية في كل ميل.",
    "about.p2":
      "ما يميزنا هو التزامنا بالتفاصيل وشغفنا بالتميز. مع أسطول يتم صيانته بدقة وسائقين مدربين باحتراف، نقدم أكثر من مجرد نقل — نخلق تجربة هادئة وفاخرة مع وسائل راحة متميزة وخدمة متحفظة ومهتمة.",
    ...
    "services.desc":
      "من خدمات النقل من وإلى المطار إلى خدمة كبار الشخصيات، نقدم مجموعة شاملة من خدمات السائق الخاص الفاخرة المصممة لتلبية احتياجاتك.",
    "services.airport.title": "نقل المطار",
    "services.airport.desc":
      "خدمة استقبال وتوصيل سلسة من وإلى المطار مع تتبع الرحلات.",
    "services.hourly.title": "سائق بالساعة",
    "services.hourly.desc":
      "حجز مرن بالساعة لاجتماعات العمل أو جولات المدينة أو المناسبات الخاصة.",
    "services.city.title": "جولات المدينة",
    "services.city.desc":
      "استكشف دبي بأقصى درجات الراحة مع تجارب جولات المدينة الفاخرة.",
    "services.corporate.title": "النقل المؤسسي",
    "services.corporate.desc":
      "خدمات سائق خاص احترافية للمديرين التنفيذيين والفعاليات المؤسسية.",
    "services.vip.title": "خدمات VIP",
    "services.vip.desc":
      "خدمات نقل حصرية لكبار الشخصيات للمناسبات الخاصة وحفلات الزفاف.",
    ...
    "contact.desc":
      "هل أنت مستعد لتجربة السفر الفاخر؟ تواصل معنا وسنرتب لك الرحلة المثالية.",
    ...
    // Footer
    "footer.tagline":
      "رحلات سلسة، راحة لا مثيل لها. خدمة السائق الخاص الفاخرة الرائدة في دبي.",
    "footer.rights":
      "لوكسي جلايد إيليت لخدمات السائق الخاص. جميع الحقوق محفوظة.",
  },
}
